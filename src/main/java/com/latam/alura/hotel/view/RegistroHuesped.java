...
import com.latam.alura.hotel.dao.Dao;
...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(HashMap<Object, Object> opts) {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				opts.put("nombre", txtNombre.getText());
				opts.put("apellido", txtApellido.getText());
				opts.put("fechaNacimiento", sdf.format(txtFechaN.getDate()));
				opts.put("nacionalidad", txtNacionalidad.getSelectedItem());
				opts.put("telefono", txtTelefono.getText());
				opts.put("nReserva", txtNreserva.getText());

				try {
					Dao dao = new Dao(opts);
					contentPane.setVisible(false);
				} catch (Exception ex) {
					JOptionPane.showMessageDialog(null, "Error al registrar el huésped");
				}
			}
		});
